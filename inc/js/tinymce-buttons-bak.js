(function() {
              ...
              onclick: function() {
                editor.windowManager.open({
                  ...
                  body: [{
                    ...
                    type: 'container',
                    html: '<span style="font-weight: 800;">Protip:</span> Use the keyboard shortcut to access this menu<br>PC/Linux: (Ctrl+Alt+C) | Mac: (Cmd+Alt+C)'
                  }],
              ...
              onclick: function() {
                editor.windowManager.open({
                  ...
                  body: [{
                    ...
                    type: 'container',
                    html: '<span style="font-weight: 800;">Protip:</span> Use the keyboard shortcut to access this menu<br>PC/Linux: (Ctrl+Alt+R) | Mac: (Cmd+Alt+R)'
                  }],
                  onsubmit: function(e) {
                    ...
                    var isPubmedCitation = true;

                    var PMIDtest = new RegExp(/^[0-9]+$/);
                    if (!PMIDtest.test(inputText)) {
  ...
  function parseRequestData(data, PMID, citationFormat, includePubmedLink, isPubmedCitation) {
